...
CREATE TABLE `game_stage` (
  ...
  `time` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK5l5cfhu0xp0jblroxt7a7tm0y` (`gid`),
  CONSTRAINT `FK5l5cfhu0xp0jblroxt7a7tm0y` FOREIGN KEY (`gid`) REFERENCES `game` (`id`)
...
INSERT INTO `game_stage` VALUES (1,1,1,2.5,5),(2,2,1,3,5);
...
-- Dump completed on 2021-11-18  0:02:39
